 ...
 */
// generated on 2018-07-19 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'openmrs-owa-chemo.ordering';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/openmrs-owa-chemo.ordering`,
	  css: `${__dirname}/app/css/openmrs-owa-chemo.ordering.css`,
	  vendor : [
